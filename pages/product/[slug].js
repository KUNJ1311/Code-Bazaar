						...
						<div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
							...
							<div className="flex">
								...
								<div className="flex sm:space-x-5 space-x-2 ml-auto">
									...
									<button className="flex text-white bg-primary border-0 py-2 sm:px-6 px-4 focus:outline-none hover:bg-primary-dark rounded text-sm sm:text-base">Add to Cart</button>
								</div>
							</div>
