										...
										<div className="relative flex items-center p-4 border-b border-gray-200 sm:grid sm:grid-cols-4 sm:gap-x-6">
											<dl className="flex-1 gap-y-1 grid grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-2 lg:col-span-2">
												...
												<div>
													...
													<dd className="mt-1 sm:text-sm text-xs font-medium text-gray-700">₹{order.amount}</dd>
												</div>
											</dl>
											...
											<div className="hidden lg:col-span-2 lg:flex lg:items-center lg:justify-end lg:space-x-4">
												...
												<Link href="#" className="flex items-center justify-center bg-white py-2 px-2.5 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none">
