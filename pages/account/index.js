		...
		<div className="flex flex-1 w-full h-full justify-center">
			<div className="flex flex-1 h-full flex-col justify-start max-w-5xl">
				...
				<div className="flex flex-wrap justify-center max-w-5xl">
					<Link href={"account/orders"} className="shadow-card min-[320px]:w-80 w-full flex items-center rounded-md px-4 py-3 hover:bg-gray-100 cursor-pointer transition-all sm:mr-4 mb-2 md:mb-4">
					...
					<Link href={"account/profile"} className="shadow-card min-[320px]:w-80 w-full flex items-center rounded-md px-4 py-3 hover:bg-gray-100 cursor-pointer transition-all sm:mr-4 mb-2 md:mb-4">
						<div className="flex justify-center items-center mr-4 w-1/4">
					...
					<Link href={"account/address"} className="shadow-card min-[320px]:w-80 w-full flex items-center rounded-md px-4 py-3 hover:bg-gray-100 cursor-pointer transition-all sm:mr-4 mb-2 md:mb-4">
						<div className="flex justify-center items-center mr-4 w-1/4">
					...
					<Link href={"account/changepassword"} className="shadow-card min-[320px]:w-80 w-full flex items-center rounded-md px-4 py-3 hover:bg-gray-100 cursor-pointer transition-all sm:mr-4 mb-2 md:mb-4">
						<div className="flex justify-center items-center mr-4 w-1/4">
