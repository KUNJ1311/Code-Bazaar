				...
				<div className="flex items-center justify-center w-full lg:p-10 pt-10 ">
					<div className="flex items-center max-[500px]:min-w-[350px] max-[360px]:min-w-[300px] max-[300px]:min-w-[230px] min-w-[500px]">
						<form className="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl">
							<h3 className="mb-3 text-4xl font-extrabold text-slate-900">Sign In</h3>
							...
							<div className="flex flex-row justify-between mb-8 ">
								...
								<Link href="/forgetpassword" className="mr-4 text-sm font-medium text-indigo-600">
									Forgot Password?
								</Link>
							</div>
							<button className="w-full px-6 py-5 mb-5 text-sm font-bold leading-none text-white transition duration-300 rounded-2xl hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-100 bg-indigo-600">Sign In</button>
