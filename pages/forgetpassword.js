				...
				<div className="sm:shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] w-full sm:w-11/12 max-w-4xl rounded-md p-6">
					<div className="grid md:grid-cols-2 items-center md:gap-8">
						<div className="max-md:order-1">
							<img src="/forgot.svg" className="md:flex hidden w-full object-cover" alt="login-image" />
						</div>
						<form className="flex flex-col w-full h-full justify-center pb-6 text-center bg-white rounded-3xl">
							<h3 className="mb-3 text-4xl font-bold text-primary">Forgot Your Password?</h3>
							...
							<button className="w-full px-6 py-5 mb-5 text-base font-semibold leading-none text-white transition duration-300 rounded-2xl hover:bg-primary-dark focus:ring-4 focus:ring-primary-light  bg-primary">Continue</button>
