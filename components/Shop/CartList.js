			...
			<ul role="list" className="divide-y divide-gray-200">
				{cart?.map((product) => (
					<li key={product.slug} className="flex py-3">
						<div className="relative h-[102px] w-[85px] cart-Image-small sm:h-[115px] sm:w-24 lg:w-32 lg:h-[153px] flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
							<Image src={product.Image} alt={product.title} className="h-full w-full object-cover object-center" />
