...
const Featured = () => {
	...
	return (
		<section className="text-center px-20 py-[40px]">
			<h2 className="text-4xl font-bold">Featured Products</h2>
			<p className="text-2xl font-medium">New Morden Design</p>
			<div className="flex">
				{data.map((data, index) => (
					<div key={index} className="px-3 py-[10px] my-[15px] mx-0 w-[23%] min-w-[250px] border rounded-[25px] border-[#cce7d0] transition duration-200 ease shadow-xl hover:shadow-2xl relative">
						...
						<div className="text-start py-[10px] px-0">
							...
							<h4 className="space-x-2 cursor-pointer">
